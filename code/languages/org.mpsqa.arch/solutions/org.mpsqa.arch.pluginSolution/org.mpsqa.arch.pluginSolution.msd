...
<solution name="org.mpsqa.arch.pluginSolution" uuid="96212ac2-423f-4cfb-b211-b58d0546b6bf" moduleVersion="0" pluginKind="PLUGIN_OTHER" compileInMPS="true">
  <models>
    ...
    <modelRoot contentPath="${module}/lib/plantuml-1.2022.2.jar!/" type="java_classes">
      <sourceRoot location="." />
    </modelRoot>
    <modelRoot contentPath="${module}/lib" type="java_classes">
      <sourceRoot location="plantuml-1.2022.2.jar" />
    </modelRoot>
  </models>
  <facets>
    <facet type="java">
  ...
  <stubModelEntries>
    <stubModelEntry path="${module}/lib/plantuml-1.2022.2.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
