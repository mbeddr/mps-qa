...
<solution name="org.mpsqa.testcov.jacoco.rt" uuid="998f9a96-8397-4ccb-acfb-d98f854aae12" moduleVersion="0" pluginKind="PLUGIN_OTHER" compileInMPS="true">
  <models>
  ...
  <stubModelEntries>
    <stubModelEntry path="${module}/lib/lib/org.jacoco.core-0.8.7.202105040129.jar" />
    <stubModelEntry path="${module}/lib/lib/org.jacoco.report-0.8.7.202105040129.jar" />
    <stubModelEntry path="${module}/lib/lib/asm-9.2.jar" />
    <stubModelEntry path="${module}/lib/lib/asm-tree-9.2.jar" />
    <stubModelEntry path="${module}/lib/lib/asm-commons-9.2.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
